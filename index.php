    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/dhaka.html">Jalandhar</a></li>
      <li>  <a href='location map/chittagong.html'>Phagwara</a></li>
       <li> <a href="location map/barishal.html">Gorakhpur</a></li>
      <li>  <a href="location map/khulna.html">Prayagraj</a></li>
     <li>   <a href='location map/mymensingh.html'>Lucknow</a></li>
     <li>   <a href='location map/rajshahi.html'>Delhi</a></li>
     <li>   <a href='location map/rangpur.html'>Mumbai</a></li>
     <li>   <a href='location map/sylhet.html'>Bhopal</a></li>
        </ul>
        </li>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Jalandhar, Panjab<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +088......<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  ambrish@gmail.com<br>
      </div>
      <?php
